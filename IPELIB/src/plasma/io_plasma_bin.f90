...
!&, tn_k,on_m3,n2n_m3,o2n_m3
&, Vn_geo_ms1_4output,tn_k,on_m3,n2n_m3,o2n_m3
...
!SMS$SERIAL(<tn_k,Vn_geo_ms1_4output,on_m3,n2n_m3,o2n_m3,IN>:default=ignore) BEGIN
!SMS$IGNORE BEGIN
#ifdef DEBUG
    ! If debugging is enabled, the activity throughout the code is logged.
...
!SMS$IGNORE END
    ...
    WRITE (unit=5998) Vn_geo_ms1_4output
...
!SMS$IGNORE END
  ...
  READ (unit=5996) tn_k
  READ (unit=5996) Vn_geo_ms1_4output
