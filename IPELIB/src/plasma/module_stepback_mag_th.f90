...
REAL, private :: maxdif=-10.
      ...
      CONTAINS
      SUBROUTINE stepback_mag_TH (utime,mp,lp,phi_t0,theta_t0,r0_apex)
...
!SMS$IGNORE begin
              print*,mype,'sub-stepback_TH: !STOP! time step',time_step,'must be reduced!',MINVAL(mlon_rad),' phi_t0=',phi_t0(ihem),MAXVAL(mlon_rad),phi_t1,VEXBe(lp,mp),mp,lp &
