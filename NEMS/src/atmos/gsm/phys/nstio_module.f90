...
!     iret              Integer(nstio_intkind) output return code
!
!   nstio_sclose      Close ocean file for sequential I/O
!     lu                Integer(nstio_intkind) input logical unit
!     iret              Integer(nstio_intkind) output return code
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
! Public Subprograms
  public nstio_sropen,nstio_swopen,nstio_sclose,nstio_srhead,nstio_swhead
...
!-------------------------------------------------------------------------------
  subroutine nstio_sclose(lu,iret)
    implicit none
    integer(nstio_intkind),intent(in):: lu
    integer(nstio_intkind),intent(out):: iret
    integer ios
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    write(*,*) ' head%clabnst done, ios : ',head%clabnst, ios
    if(ios.ne.0) return
