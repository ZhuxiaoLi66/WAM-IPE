...
!
     ...
     &                               ls_dim,ls_max_node,me,nodes,me
...
!
!     if (nvars == 192) then
!     write(150+me,*)' in for2fln maxfr=',maxval(four_gr(:,nvars,:)),
!    &  ' minfr=',minval(four_gr(:,nvars,:))
!     endif
!!
      ifin=lats_node
!!
...
!
!     if (nvars == 192) then
!     write(150+me,*)' in for2fln maxclw=',maxval(flnev(:,:,nvars)),
!    &  ' minclw=',minval(flnev(:,:,nvars))
!     endif
