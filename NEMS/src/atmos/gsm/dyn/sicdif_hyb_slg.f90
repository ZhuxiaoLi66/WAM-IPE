...
!#include "f_hpm.h"
      ...
      use gfs_dyn_resol_def      , only : jcap,levs
      use gfs_dyn_layout1        , only : len_trie_ls,ls_dim
!sela use akbk_hyb_def
      use gfs_dyn_coordinate_def , only : am_slg,bm_slg,d_slg_m,sv_slg,
     &                                    tor_slg
      implicit none
...
!#include "f_hpm.h"
      use gfs_dyn_machine        , only : kind_evod
      use gfs_dyn_resol_def      , only : jcap,levs
      use gfs_dyn_layout1        , only : len_trio_ls,ls_dim
!sela use akbk_hyb_def
      use gfs_dyn_coordinate_def , only : am_slg,bm_slg,d_slg_m,sv_slg,
     &                                    tor_slg
      implicit none
