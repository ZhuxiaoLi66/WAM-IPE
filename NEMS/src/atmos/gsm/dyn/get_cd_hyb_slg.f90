      ...
      use gfs_dyn_machine        , only : kind_evod,kind_phys
      use gfs_dyn_resol_def      , only : jcap1,levs
!sela use akbk_hyb_def
      use gfs_dyn_coordinate_def, only : am_slg,bm_slg,
...
!sela use akbk_hyb_def
      use gfs_dyn_coordinate_def , only : ak5,am_slg,bk5,bm_slg,
     &                                    sv_ecm,sv_slg,t_ecm,tor_slg,
     &                                    y_ecm
      use namelist_dynamics_def  , only : ref_temp, ref_pres
      use gfs_dyn_physcons       , only : rd => con_rd,
     &                                    cp => con_cp,
     &                                rearth => con_rerth
      implicit none
