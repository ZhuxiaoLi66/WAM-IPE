...
!hmhj          dpme(indev,1,k) =         dpme(indev,1,k)
!hmhjx                         + filtb * dpe (indev,1,k)
!hmhj          dpme(indev,2,k) =         dpme(indev,2,k)
!hmhjx                         + filtb * dpe (indev,2,k)
...
!hmhj no need to have filter for dp
!hmhj          dpmo(indod,1,k) =         dpmo(indod,1,k)
!hmhjx                         + filtb * dpo (indod,1,k)
!hmhj          dpmo(indod,2,k) =         dpmo(indod,2,k)
!hmhjx                         + filtb * dpo (indod,2,k)
