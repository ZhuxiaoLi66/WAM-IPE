...
!
      ...
      use gfs_dyn_layout1   , only : nodes,me
...
!
     ...
     &,                    jcount,jpt,lat,lats_sum,node,i
...
!     write(1000+me,*)'in setlats lat=',lat,' latg=',latg,' ifin=',ifin
...
!    &,' irest=',irest
        ...
        if (ngrptl*nodesio <= ngrptg+irest) then
          ...
          idp = idp + 1
!         write(1000+me,*)' nodesio1=',nodesio,' idp=',idp,' ipe=',ipe
        else
          ipe = ipe + 1
...
!       write(1000+me,*)' lat=',lat,' lats_nodes_a=',lats_nodes_a(ipe+1)
!    &,' ipe+1=',ipe+1
      enddo
!!
!!........................................................
!!
      jpt = 0
      do node=1,nodesio
!       write(1000+me,*)'node=',node,' lats_nodes_a=',lats_nodes_a(node)
...
!           write(1000+me,*)' jpt+jcount=',jpt+jcount
