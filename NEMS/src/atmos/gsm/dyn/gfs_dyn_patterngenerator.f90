   ...
   do np=1,npatterns
      ...
      if (me == me_l_0) then
         ...
         if (iseed(np) == 0) then
           ...
           ! iseed is elapsed time since 1 epoch began (secs)
...
end module gfs_dyn_patterngenerator
